package com.wei.controller.base;

import com.baomidou.mybatisplus.plugins.Page;
import com.wei.config.shiro.ShiroUser;
import com.wei.untils.json.JsonResponseData;
import com.wei.untils.page.PageInfo;
import com.wei.untils.string.StringEscapeEditor;
import com.wei.untils.url.URLUtils;
...
public abstract class BaseController {
	...
	protected ResponseEntity<Resource> download(File file, String fileName) {
		...
		if (header.contains("MSIE") || header.contains("TRIDENT") || header.contains("EDGE")) {
			fileName = URLUtils.encodeURL(fileName, StandardCharsets.UTF_8);
